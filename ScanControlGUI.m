function ScanControlGUI()
    ...
    % 振镜参数
    paramPanel = uipanel(fig, 'Title', '振镜参数', 'Position', [20, 400, 300, 280]);
    uilabel(paramPanel, 'Text', '振镜串口:', 'Position', [10, 230, 80, 22]);
    galvanoPortEdit = uieditfield(paramPanel, 'text', 'Value', 'COM3', 'Position', [100, 230, 100, 22]);
    
    uilabel(paramPanel, 'Text', '波特率:', 'Position', [10, 200, 80, 22]);
    baudRateEdit = uieditfield(paramPanel, 'numeric', 'Value', 115200, 'Position', [100, 200, 100, 22]);
    
    uilabel(paramPanel, 'Text', 'X轴区间(mm):', 'Position', [10, 170, 80, 22]);
    xRangeEdit = uieditfield(paramPanel, 'numeric', 'Value', 100, 'Position', [100, 170, 100, 22]);
    
    uilabel(paramPanel, 'Text', 'Y轴区间(mm):', 'Position', [10, 140, 80, 22]);
    yRangeEdit = uieditfield(paramPanel, 'numeric', 'Value', 0, 'Position', [100, 140, 100, 22]);
    
    uilabel(paramPanel, 'Text', '步长(mm):', 'Position', [10, 110, 80, 22]);
    stepEdit = uieditfield(paramPanel, 'numeric', 'Value', 1, 'Position', [100, 110, 100, 22]);
    
    uilabel(paramPanel, 'Text', '暂停时间(s):', 'Position', [10, 80, 80, 22]);
    pauseTimeEdit = uieditfield(paramPanel, 'numeric', 'Value', 5.3816, 'Position', [100, 80, 100, 22]);
    
    uilabel(paramPanel, 'Text', '起始X(mm):', 'Position', [10, 50, 80, 22]);
    xStartEdit = uieditfield(paramPanel, 'numeric', 'Value', 0, 'Position', [100, 50, 100, 22]);
    
    uilabel(paramPanel, 'Text', '起始Y(mm):', 'Position', [10, 20, 80, 22]);
    yStartEdit = uieditfield(paramPanel, 'numeric', 'Value', 1, 'Position', [100, 20, 100, 22]);
    ...
    uilabel(laserPanel, 'Text', '场镜焦距(mm):', 'Position', [10, 10, 80, 22]);
    focalLengthEdit = uieditfield(laserPanel, 'numeric', 'Value', 174, 'Position', [100, 10, 100, 22]);
    ...
    function startScan()
        try
            ...
            download('QSwitch', laserPort, voltage, frequency);
